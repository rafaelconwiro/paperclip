    ...
    return (
      <div className="text-sm text-destructive">
        {heartbeatsQuery.error instanceof Error
          ...
          : t("Failed to load scheduler heartbeats.")}
      </div>
    );
  }
  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      <div className="flex items-center gap-4 text-sm text-muted-foreground">
        ...
        <span><span className="font-semibold text-foreground">{grouped.length}</span> {grouped.length === 1 ? t("company") : t("companies")}</span>
        {anyEnabled && (
          <Button
            variant="destructive"
            size="sm"
          ...
          >
            {disableAllMutation.isPending ? t("Disabling...") : t("Disable All")}
          </Button>
        )}
      </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="ml-auto flex items-center gap-1.5 shrink-0">
                          ...
                          >
                            {saving ? "..." : agent.heartbeatEnabled ? t("Disable Timer Heartbeat") : t("Enable Timer Heartbeat")}
                          </Button>
                        </span>
                      </div>
                    );
